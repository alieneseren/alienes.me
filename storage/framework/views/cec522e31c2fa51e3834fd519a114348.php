    ...
    <div class="max-w-md w-full">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 border border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-6 pt-6 border-t dark:border-gray-700 text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-sm text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300 font-medium transition">
                    ← Ana Sayfaya Dön
                </a>
            </div>
        </div>
...
</html><?php /**PATH /Users/alienes/alienes.me/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>