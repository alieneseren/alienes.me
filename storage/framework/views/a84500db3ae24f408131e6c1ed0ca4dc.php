<?php $__env->startSection('title', $category->name . ' - Çalışma Notları'); ?>
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <nav class="text-sm mb-6">
            <ol class="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
                ...
                <li><span>/</span></li>
                <li class="text-gray-900 dark:text-white font-semibold"><?php echo e($category->name); ?></li>
            </ol>
        </nav>
        ...
        <div class="bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg p-4 sm:p-6 md:p-8 mb-6 md:mb-8 text-white">
            <div class="flex items-center mb-4">
                <span class="text-4xl sm:text-5xl md:text-6xl mr-3 sm:mr-4 flex-shrink-0"><?php echo e($category->icon); ?></span>
                <div class="min-w-0 flex-1">
                    <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold break-words"><?php echo e($category->name); ?></h1>
                    <p class="text-primary-100 mt-1 sm:mt-2 text-sm sm:text-base break-words"><?php echo e($category->description); ?></p>
                </div>
            </div>
            <div class="text-xs sm:text-sm text-primary-200"><?php echo e($notes->count()); ?> ders notu mevcut</div>
        </div>

        <!-- Notes List -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('study.show', [$category->slug, $note->slug])); ?>" 
               class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700 hover:border-primary-500 dark:hover:border-primary-500">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <div class="w-10 h-10 sm:w-12 sm:h-12 bg-primary-50 dark:bg-primary-900/30 rounded-lg flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-primary-100 dark:group-hover:bg-primary-900/50 transition-colors flex-shrink-0">
                        <?php if(str_contains(strtolower($note->title), 'test')): ?>
                        ...
                        <?php elseif(str_contains(strtolower($note->title), 'flashcard')): ?>
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path>
                            </svg>
                        <?php elseif(str_contains(strtolower($note->title), 'formül') || str_contains(strtolower($note->title), 'özet')): ?>
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                            </svg>
                        <?php elseif(str_contains(strtolower($note->title), 'pratik')): ?>
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 line-clamp-2 break-words"><?php echo e($note->description); ?></p>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700">
                        <div class="flex items-center text-xs text-gray-500 dark:text-gray-500">
                            ...
                            <span class="truncate"><?php echo e($note->views); ?></span>
                        </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alienes/alienes.me/resources/views/study/category.blade.php ENDPATH**/ ?>