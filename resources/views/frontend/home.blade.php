...
@section('content')
    ...
    <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            ...
            <img src="{{ asset('images/hero-bg.jpg') }}" alt="Background" class="w-full h-full object-cover object-center opacity-40 dark:opacity-30 blur-[1px]">
            <!-- Gradient Overlay -->
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center md:text-left animate-fadeIn">
                    <h1 class="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-4">
                        {{ $profile->full_name ?? 'Ali Enes Eren' }}
                    </h1>
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-xl">
                        {{ $profile->bio ?? 'Full Stack Developer passionate about creating innovative web solutions.' }}
                    </p>
    ...
    <!-- Experience Section -->
    {{-- ⚡ Bolt: Replace count() > 0 with isNotEmpty() to avoid unnecessary collection iteration --}}
