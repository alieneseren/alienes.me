...
<head>
    ...
    @php
        ...
        // Check if sections have content (Cached and optimized)
        $layoutVisibility = \Illuminate\Support\Facades\Cache::rememberForever('frontend.layout.visibility', function () {
            return [
        ...
        $hasExperiences = $layoutVisibility['hasExperiences'];
        $hasSkills = $layoutVisibility['hasSkills'];
        $hasProjects = $layoutVisibility['hasProjects'];
        $hasCv = $layoutVisibility['hasCv'];
    @endphp
