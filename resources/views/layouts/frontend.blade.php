...
<head>
    ...
    @php
        ...
        $layoutFlags = \Illuminate\Support\Facades\Cache::rememberForever('frontend_layout_flags', function () {
            return [
                'hasExperiences' => \App\Models\Experience::exists(),
                'hasSkills' => \App\Models\Skill::exists(),
                'hasProjects' => \App\Models\Project::exists(),
                'hasPublishedCv' => \App\Models\Cv::where('is_published', true)->exists(),
            ];
        });

        $hasExperiences = $layoutFlags['hasExperiences'];
        $hasSkills = $layoutFlags['hasSkills'];
        $hasProjects = $layoutFlags['hasProjects'];
        $hasPublishedCv = $layoutFlags['hasPublishedCv'];
    @endphp
