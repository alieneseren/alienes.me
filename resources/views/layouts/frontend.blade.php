...
<head>
    ...
    @php
        $frontendData = \Illuminate\Support\Facades\Cache::remember('frontend_layout_data', 3600, function () {
            return [
        ...
        $hasExperiences = $frontendData['hasExperiences'];
        $hasSkills = $frontendData['hasSkills'];
        $hasProjects = $frontendData['hasProjects'];
        $hasCv = $frontendData['hasCv'];
