...
class HomeController extends Controller
{
    ...
    {
        // ⚡ Bolt: Cache home page data to prevent 5 redundant DB queries per request.
        // Cache is automatically invalidated by ClearsHomePageCache trait when models are updated.
