...
class HomeController extends Controller
{
    ...
    {
        // ⚡ Bolt: Cache all homepage data forever to avoid multiple database queries per request.
        // The cache will be invalidated when any of these models are saved or deleted.
